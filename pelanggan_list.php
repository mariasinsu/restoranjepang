  ...
  <aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Maria Sinsu</a>
        </div>
      </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table class="table table-bordered table-hover"> 
                 ...
                 <?php
                 //menuliskan querry mengambil data
                 $no = 1;
                 ...
                 while($data = $q->fetch_assoc()){ ?>
                    <tr>
                        ...
                        <td>
                        <a href="edit_pelanggan_form.php?Id_Pelanggan=<?php echo $data['Id_Pelanggan']?>" class="btn-sm btn-warning">
                          <i class="fas fa-edit mr-1"></i> Ubah</a>
                          <a href="delete_pelanggan_action.php?Id_Pelanggan=<?php echo $data['Id_Pelanggan']?>"
                           class="btn-sm btn-danger" onclick="return confirm('Yakin Nih?')">
